...
const VIDEOS = [
  {
    ...
    caption: "Official television ad broadcast showcasing Agrishield premium range",
    views: "3.2L",
    date: "Recent",
  },
  {
    ...
    caption: "Step-by-step application guide for mango flowering and yield optimization",
    views: "98K",
    date: "Recent",
  },
  {
    ...
    caption: "Caltar Plus paclobutrazol performance in direct field assessment",
    views: "2.1L",
    date: "Recent",
  },
  {
    ...
    caption: "Visible results of paclobutrazol application on mango crops",
    views: "64K",
    date: "Recent",
  },
];
